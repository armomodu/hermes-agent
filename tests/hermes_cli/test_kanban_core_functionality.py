...
def test_gateway_dispatcher_quarantines_torn_extend_board_db(
    monkeypatch, tmp_path, caplog
):
    """A torn-extend/page-count mismatch is treated as a quarantinable corrupt board."""
    import asyncio
    import logging
    import sqlite3
    ...
    def _connect(*args, **kwargs):
        ...
        raise sqlite3.DatabaseError(
            "torn-extend detected: page count mismatch on /tmp/kanban.db: "
            "header claims 2057 pages, file has 2056 pages"
        )
